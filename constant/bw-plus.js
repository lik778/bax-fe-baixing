...
export const AUDIT_STATUS_DONE = 1
export const AUDIT_STATUS_EXPIRED = 3
export const AUSIT_STATUS_PENDING_CONFIRM = 4
export const AUDIT_STATUS_PENDING_RECOMMIT = 5
export const AUDIT_STATUS_CONFIRMED = 6
...
export const AUDIT_STATUS_MAP = {
  ...
  [AUDIT_STATUS_DONE]: '审核通过',
  [AUDIT_STATUS_EXPIRED]: '已过期',
  [AUSIT_STATUS_PENDING_CONFIRM]: '待运营确认',
  [AUDIT_STATUS_PENDING_RECOMMIT]: '待重新提单',
  [AUDIT_STATUS_CONFIRMED]: '已确认付款'
}
export const AUDIT_STATUS_COLOR_MAP = {
  [AUDIT_STATUS_PENGDING]: 'info',
  [AUSIT_STATUS_PENDING_CONFIRM]: 'info',
  [AUDIT_STATUS_PENDING_RECOMMIT]: 'info',
  [AUDIT_STATUS_DONE]: 'success',
  [AUDIT_STATUS_REJECT]: 'warning',
  [AUDIT_STATUS_EXPIRED]: 'warning',
  [AUDIT_STATUS_CONFIRMED]: 'success'
}
...
export const notAllowTidan = [
  AUDIT_STATUS_REJECT,
  AUDIT_STATUS_EXPIRED,
  AUDIT_STATUS_PENGDING,
  AUSIT_STATUS_PENDING_CONFIRM,
