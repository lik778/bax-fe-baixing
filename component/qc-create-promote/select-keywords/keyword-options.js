...
export default {
  ...
  B: {
    ...
    placeholder:
      '如：，A380、工业、民用、塑料、不锈钢、金属、进口、国产、靠谱、专业、质量好的、价格低的、很好的、优质的、优良的、优惠的、省心的、齐全的、技术好的、应用多的、效果好的、稳定的、耐用的、好用的、规模大的……',
    keywords: [],
  ...
  D: {
    ...
    info: `<p>多个关键词换行、中英文逗号隔开；</p>
           ...
           <p>单个词长度不少于2个字，不超过8个字；</p>
           <p>百度投放仅支持小写，输入大写时数据会被强制更改为小写。</p>`,
    placeholder: '如：，价格、厂商、厂家、批发、多少钱、怎么样、在线咨询、最新价格、今日报价、信赖推荐、值得信赖、货真价实、量大从优、厂家供应、询问报价、免费咨询、价格行情、厂家直供、品质售后无忧、今日行情……',
    keywords: [],
